...
%Display of Results
%----------------------------------------------------------
figure(1);imshow(I1);title('original watermarked image');
figure(2);imshow(Original_image);title('original resized w image');
figure(3);imshow(K);title('restored image from dct after jpeg compression');
